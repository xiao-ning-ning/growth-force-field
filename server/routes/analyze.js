...
如果通篇录音都是正面行为：
1. 降低置信度评估（如从"强"降为"中"）
2. 从说话人的措辞中寻找自我反省、自我批评、或对团队问题的隐忧——这些本身就是负面信号
3. 如果实在找不到负面证据，在 summary 中明确说明"本次分析未发现待发展维度，能力表现一致正面"
4. **绝不为了满足要求而虚构负面证据**——有就是有，没有就是没有，宁可如实也不造假
...
**每次 matchedDimensions 结果中，必须至少包含 1 个 polarity="-1" 的证据。** 如果通篇都是正面行为：
- 降低 confidence
- 从说话人自我批评、团队问题、潜在风险中寻找负面信号
- **绝不虚构负面证据**
